...
# to get the word list ready:
# ability n S2, W1 -> ability and then sort the list as well as remove duplicates
# awk '{print $1 "\r\n"}' 3000.txt > 3000-2.txt
# sort -k2n 3000-2.txt | uniq > 3000-3.txt 
# wc -l 3000-3.txt
# to get windows components worked: install win32 module beforehand
